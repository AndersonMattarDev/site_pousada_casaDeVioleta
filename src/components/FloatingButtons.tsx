  ...
  return (
    <div className="fixed right-4 bottom-6 flex flex-col gap-3 z-50">
      <a
        ...
        className="bg-violeta-600 text-white px-4 py-3 rounded-full shadow-lg flex items-center gap-2 hover:opacity-90 transition"
      >
        Reservar Agora
      </a>
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="bg-green-500 text-white px-4 py-3 rounded-full shadow-lg flex items-center gap-2 hover:opacity-90 transition"
      >
